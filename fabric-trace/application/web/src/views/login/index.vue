    ...
    <div class="login-box">
      <div class="login-content">
        <div class="login-logo">
          ...
          <span class="logo-text">茅台酒溯源系统</span>
        </div>
          ...
          <div v-show="isLoginPage" class="form-container">
            ...
            <div class="form-body">
              ...
              <div class="button-container">
                <el-button :loading="loading" type="primary" class="login-button" @click.native.prevent="handleLogin">登
                  录</el-button>
          ...
          <div v-show="!isLoginPage" class="form-container">
            ...
            <el-form-item prop="password">
              ...
              <el-input :key="passwordType" ref="password" v-model="registerForm.password" :type="passwordType"
                placeholder="请输入密码" name="password" auto-complete="on" />
              <span class="show-pwd" @click="showPwd">
                <svg-icon :icon-class="passwordType === 'password' ? 'eye' : 'eye-open'" />
              </span>
            </el-form-item>
            ...
            <div class="button-container">
              ...
              <el-button :loading="loading" type="primary" class="register-submit"
      ...
      <div class="login-footer">
        <span>Copyright © 2024 茅台酒溯源系统. All rights reserved.</span>
      </div>
    </div>
  </div>
</template>
